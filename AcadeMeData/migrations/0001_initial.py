...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='University',
            fields=[
                ('university_id', models.IntegerField(default=0, primary_key=True, serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('CS', 'Computer Science'),
                                                     ('PS', 'Psychology'), ('GV', 'Government'),
                                                     ('BA', 'Business Administration'), ('UN', 'Unknown')],
                                            default='UN', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
            fields=[
                ('professor_id', models.IntegerField(default=0, primary_key=True, serialize=False,
                                                     validators=[django.core.validators.MinValueValidator(0)])),
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True, null=True)),
