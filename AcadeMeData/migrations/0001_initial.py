...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Degree',
            fields=[
                ('degree_id', models.IntegerField(default=0, primary_key=True,
                                                  serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('university', models.CharField(choices=[('RU', 'Reichman University'),
                                                         ('HU', 'Hebrew University'), ('TA', 'Tel Aviv University'),
                                                         ('BS', "Be'er Sheva University"), ('UN', 'Unknown')],
                                                default='UN', max_length=2)),
                ('degree', models.CharField(choices=[('CS', 'Computer Science'), ('PS', 'Psychology'),
                                                     ('GV', 'Government'), ('BA', 'Business Administration'),
                                                     ('UN', 'Unknown')], default='UN', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professor', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT,
                                                to='AcadeMeData.professor')),
            ],
        ),
    ]
